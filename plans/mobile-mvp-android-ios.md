...
- **Pendiente, bloqueado por assets que no existen todavía:** icono final y gráfico de feature (necesitan un logo real, el proyecto sigue con el icono por defecto del scaffold).
