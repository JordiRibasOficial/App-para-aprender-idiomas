...
- **Idiomas de lanzamiento (MVP): inglés + 3 más — pendiente de fijar el trío exacto** (propuesta con datos de mercado: portugués y francés por cercanía/coste de contenido más bajo, más un cuarto a decidir entre japonés —mayor crecimiento de demanda— u otro). Confirmar antes de cerrar el Paso 3.
...
## Paso 3 — Modelo de contenido multi-idioma y curso de inglés completo
