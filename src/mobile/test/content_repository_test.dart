...
void main() {
  ...
  group('AssetContentRepository', () {
    ...
    test(
      'all exercise ids are unique within each course (no copy-paste id collisions)',
      () async {
        final repository = AssetContentRepository();
    ...
    test(
      'rejects a targetLanguage outside the known catalogue instead of building an asset path from it',
      () async {
        final repository = AssetContentRepository();
