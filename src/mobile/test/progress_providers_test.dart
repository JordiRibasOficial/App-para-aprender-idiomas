...
void main() {
  test('progressProvider persists lesson completion through the repository', () async {
  ...
  test('progress is tracked independently per target language', () async {
    ...
    expect(container.read(progressProvider('en')).requireValue.completedLessonIds, {'u1_l1'});
    expect(container.read(progressProvider('pt')).requireValue.completedLessonIds, isEmpty);
  });
}
