// Can't use an initializing formal (`this._verifier`): that would force the
// external named parameter to be the private name itself (`_verifier`),
// which callers in other files can't reference — see the comment on the
// constructor.
