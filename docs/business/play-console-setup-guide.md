...
|---|---|---|
| Dirección de email | **Sí, opcional** | Solo si el usuario elige "continuar con email" en el onboarding (`auth_choice_screen.dart`) en vez de "continuar como invitado". Se guarda **únicamente en el dispositivo**, cifrado (`flutter_secure_storage`). No se usa para crear cuenta ni se envía a ningún servidor. |
