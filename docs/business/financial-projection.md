...
|---|---|---|
| Precio mensual | €7.99 | Placeholder del Paso 8, pendiente de confirmar (marcado como TODO en el código) |
| Precio anual | €44.99 (ahorro ~53%) | Placeholder del Paso 8, mismo TODO |
...
|---|---|---|---|---|
| Conservador | 5.000 | 150 | ~€900 | ~€765 |
| Base | 15.000 | 450 | ~€2.700 | ~€2.295 |
| Optimista | 40.000 | 1.200 | ~€7.200 | ~€6.120 |
...
Con el escenario conservador (~€765 netos/mes desde el mes 12), los ~124 USD de coste de las cuentas de tienda se recuperan mucho antes del mes 12 en cualquier escenario — este no es el riesgo financiero real del proyecto. El riesgo real es la validación de la tasa de conversión y el crecimiento orgánico, ninguno de los dos medido todavía.

## Qué falta para que esto sea una proyección financiera de verdad

- Confirmar el precio real de la suscripción (Paso 13).
